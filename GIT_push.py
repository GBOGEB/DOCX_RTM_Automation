...
subprocess.run(['git', 'config', '--global', 'user.email', 'gerkotze.bonthuys@sckcen.be'], check=True)

# Add the remote repository
subprocess.run(['git', 'remote', 'add', 'origin', 'https://github.com/GBOGEB/DOCX_RTM_Automation.git'], check=True)
