...
[11](#_Toc195865357)](#_Toc195865357)
...
: []{#_Toc195865364 .anchor}Figure 9 Software Change Management
...
: []{#_Toc195865368 .anchor}Figure 12 Cool-down power for Thermal
...
2.  Functional Safety & Control
  ...
  *10.1*.[]{#_Toc195865387 .anchor}Table 17 Cool-down power below 50 K
  (4 K/h)
...
3.  Asset & Maintenance Management
  ...
  : []{#_Toc197426038 .anchor}Applicable DocumentsSCK CEN will provide
  ...
  final documentation.[]{#_Toc195865388 .anchor}Table 18 Applicable
  Documents (AD)
...
#### 1.4.4 Cooldown to 50 K {#cooldown-to-50-k .C5-Headings}
...
#### 1.4.5 Cool-down to 4.5 K {#cool-down-to-4.5-k .C5-Headings}
...
#### 1.4.6 LHe filling  {#lhe-filling .C5-Headings}

#### 1.4.7 When the cavities reach the liquid helium temperature, the liquid filling of the helium baths can start. Cooldown to 2 K {#when-the-cavities-reach-the-liquid-helium-temperature-the-liquid-filling-of-the-helium-baths-can-start.-cooldown-to-2-k .C5-Headings}
