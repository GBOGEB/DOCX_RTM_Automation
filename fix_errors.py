...
def fix_toc_depth_in_code():
    ...
    for file_path in files_to_fix:
        ...
        try:
            ...
            patterns_to_fix = [
                (r'--toc-depth=6', '--toc-depth=6'),
                (r'--toc-depth=6', '--toc-depth=6'),
                (r'--toc-depth=6', '--toc-depth=6'),
                (r'--toc-depth=10', '--toc-depth=6'),
                (r'toc_depth=6', 'toc_depth=6'),
                (r'toc_depth=6', 'toc_depth=6'),
                (r'toc_depth=6', 'toc_depth=6'),
...
def fix_repository_url(file_path):
