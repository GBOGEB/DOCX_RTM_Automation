...
def git_operations():
    ...
    if choice == "1":
        ...
        subprocess.run("git config --global user.email \"your.email@example.com\"", shell=True)
    ...
    while True:
        ...
        if choice == 'A':
            ...
            if config_choice == "1":
                ...
                os.system(f'start global_config.yaml' if os.name == 'nt' else f'open global_config.yaml')
            
        elif choice == 'J':
            print("\n=== Help & Documentation ===")
            print("Opening README...")
            os.system('start README.md' if os.name == 'nt' else 'cat README.md | less')
