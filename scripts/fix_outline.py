    ...
    try:
        ...
        for line in content.split("\n"):
            ...
            # If it's a child section entry
                ...
                in_yaml_section
                and line.strip().startswith("- title:")
                and current_section
            ):
                title = line.split("- title:", 1)[1].strip()
        ...
        outline = {"title": "Document Outline", "sections": []}
...
def create_sample_outline(output_file):
    ...
    outline = {
        ...
        "sections": [
            ...
            {"level": 2, "title": "Scope", "number": "1.2"},
            {"level": 1, "title": "System Requirements", "number": "2"},
            {"level": 2, "title": "Functional Requirements", "number": "2.1"},
            {"level": 3, "title": "User Management", "number": "2.1.1"},
        ],
    }
